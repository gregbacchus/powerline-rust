...
const NEW_LINE_CMD_DISABLED_FLAG: &str = "-lf_cmd";
const NEW_LINE_CMD_ENABLED_FLAG: &str = "lf_cmd";
const NEW_LINE_START_DISABLED_FLAG: &str = "-lf_start";
const NEW_LINE_START_ENABLED_FLAG: &str = "lf_start";
